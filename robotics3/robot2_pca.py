...
speed_scale = Scale(frmSpeed, from_=0, to=100, orient=HORIZONTAL, command=changeSpeed)  # Create a scale
speed_scale.set(50)
#speed.grid(row=3, column=1)
speed_scale.pack()

frmRunBtn.grid(row=1,column=0)
