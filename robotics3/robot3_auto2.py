...
def KeyPress_W(event):
    ...
    #thread.start_new_thread(forward_distance_chk, ("Thread-1",))  
...
btnGetDis = Button(frmUltraSonicBtn, text='get_distance(T)'  , fg="black", bd=3, height=3, width=15)
lbDis     = Label (frmUltraSonicBtn, text='Distance : 9999cm', fg="red"  , font=20, justify=LEFT, textvariable=strDis )
btnSerch  = Button(frmUltraSonicBtn, text="SerchDirection"   , fg="black", bd=3, height=3, width=15, command=SerchDirection)
